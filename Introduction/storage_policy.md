...
New part 的 size 是一个估算值，insert 时候 part size 使用未压缩的 part size 估算，merge 的时候使用合并后的压缩大小之和+10%来估算，因此 <em>有可能较大的 part 在 hot volumn，而较小的 part 在 cold volumn</em>。
